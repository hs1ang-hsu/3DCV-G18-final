...
REM python train.py --dataset dataset/data_64.npz --kp 64 --feature_dim 16
REM python train.py --dataset dataset/data_64.npz --kp 64 --feature_dim 16 --using_trans

:: naive
REM python train.py

:: transfomer
REM python train.py --dataset dataset/data_64.npz --kp 64 --feature_dim 16 REM with tcn
REM python train.py --dataset dataset/data_64.npz --kp 64 --feature_dim 16 REM with pure transformer

:: original
REM python train.py --dataset dataset/data_64.npz --kp 64 --feature_dim 16 --channels 2048 --num_epoch 30
