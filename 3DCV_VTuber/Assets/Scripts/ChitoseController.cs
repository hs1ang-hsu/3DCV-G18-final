...
public class ChitoseController : MonoBehaviour, ISaveable
{
    ...
    private float ear_left = 0f, ear_right = 0f;
    ...
    void Start()
    {
        ...
        expression.GetComponent<TextMeshPro>().text = "Normal";
    ...
    void EyeBlinking()
    {
        ...
        var parameter = model.Parameters[5];//model.Parameters[6];
        parameter.Value = eye_L_value;
        //Debug.Log("eye_L_value: "+eye_L_value);
        ...
        //Debug.Log("eye_L_value: " + eye_R_value);
    }
    ...
    void MouthOpening()
    {
        ...
        var parameter = model.Parameters[20];
    ...
    {
        int emotionId = Convert.ToInt32(emotion);
        switch (emotionId)
        {
            case 0: // Neutral
            ...
            case 1: // Anger
                ...
                expression.GetComponent<TextMeshPro>().text = "Anger";
                break;
            case 2: // Disgust
                expressionControl.CurrentExpressionIndex = 2;
                expression.GetComponent<TextMeshPro>().text = "Disgust";
                break;
            case 3: // Fear
                expressionControl.CurrentExpressionIndex = 3;
                expression.GetComponent<TextMeshPro>().text = "Fear";
                break;
            case 4: // Happiness
                expressionControl.CurrentExpressionIndex = 4;
                expression.GetComponent<TextMeshPro>().text = "Happiness";
                break;
            case 5: // Sadness
                expressionControl.CurrentExpressionIndex = 5;
                expression.GetComponent<TextMeshPro>().text = "Sadness";
                break;
            case 6: // Surprise
                expressionControl.CurrentExpressionIndex = 6;
                expression.GetComponent<TextMeshPro>().text = "Surprise";
                break;
            default:
                expressionControl.CurrentExpressionIndex = 0;
                expression.GetComponent<TextMeshPro>().text = "Normal";
