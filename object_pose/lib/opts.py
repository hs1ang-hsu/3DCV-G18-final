...
class opts(object):
    def __init__(self):
        ...
        # model
        self.parser.add_argument("--frame", type=int, default=27)
        self.parser.add_argument("--kp", type=int, default=34)
        self.parser.add_argument("--feature_dim", type=int, default=3)
        self.parser.add_argument("--hidden_dim", type=int, default=256)
        self.parser.add_argument("--channels", type=int, default=1024)
        self.parser.add_argument("--out_dim", type=int, default=64)
        self.parser.add_argument("--num_classes", type=int, default=7)
        self.parser.add_argument('--using_trans', action='store_true')
        ...
        # Model
        self.parser.add_argument('--arch', default='dlav1_34',
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        opt.num_classes_op = dataset.num_classes
        ...
        opt.heads = {'hm': opt.num_classes_op, 'wh': 2, 'hps': 16}
