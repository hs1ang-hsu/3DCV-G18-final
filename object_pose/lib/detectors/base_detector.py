...
from object_pose.lib.models.model import create_model, load_model
from object_pose.lib.utils.image import get_affine_transform, affine_transform
from object_pose.lib.utils.debugger import Debugger

from object_pose.lib.utils.pnp.cuboid_pnp_shell import pnp_shell

from object_pose.lib.utils.tracker import Tracker
from object_pose.lib.utils.tracker_baseline import Tracker_baseline

from object_pose.lib.utils.image import draw_umich_gaussian, gaussian_radius, draw_nvidia_gaussian
...
class BaseDetector(object):
    ...
    def run(self, image_or_path_or_tensor, filename=None, meta_inp={}, preprocessed_flag=False):
        ...
        ret = {'results': results, 'boxes': boxes, 'output': output, 'tot': tot_time, 'load': load_time,
